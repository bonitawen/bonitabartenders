...
function () {
  function ElementAnimation(elem) {
    _classCallCheck(this, ElementAnimation);

    this.elem = elem;
  }

  _createClass(ElementAnimation, [{
    key: "isNotUndefined",
    ...
    key: "zeroOpacity",
    value: function zeroOpacity() {
      this.elem.classList.add('js-zero-opacity');
    }
  }, {
    key: "fullOpacity",
    value: function fullOpacity() {
    ...
    key: "isHalfInViewport",
    value: function isHalfInViewport() {
      this.bounding = this.elem.getBoundingClientRect();
    ...
    key: "slideUpStartPos",
    value: function slideUpStartPos() {
      var startPos = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
      this.elem.classList.add('js-zero-opacity');
      this.elem.style.transform = "translateY(".concat(startPos, "px)");
    }
  }, {
    key: "slideRightStartPos",
    value: function slideRightStartPos() {
    ...
    key: "slideLeftStartPos",
    value: function slideLeftStartPos() {
      var startPos = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 40;
      this.elem.classList.add('js-zero-opacity');
      this.elem.style.transform = "translateX(".concat(startPos, "vw)");
    }
    ...
    key: "slideEndPos",
    value: function slideEndPos() {
      var _this2 = this;

      var duration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 600;
      var easing = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'ease-in-out';
      setTimeout(function () {
        _this2.elem.classList.add('js-full-opacity');

        _this2.elem.style.transform = "translate(0)";
        _this2.elem.style.transition = "opacity ".concat(duration, "ms ").concat(easing, ", transform ").concat(duration, "ms ").concat(easing);
      });
    }
  }, {
    key: "slideEndPosTransparent",
    value: function slideEndPosTransparent() {
      var _this3 = this;

      var duration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 600;
      var easing = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'ease-in-out';
      setTimeout(function () {
        _this3.elem.classList.add('js-94-opacity');

        _this3.elem.style.transform = "translate(0)";
        _this3.elem.style.transition = "opacity ".concat(duration, "ms ").concat(easing, ", transform ").concat(duration, "ms ").concat(easing);
      });
    }
  }]);
...

{
  ...
  var hoursH4 = new ElementAnimation(document.querySelector('.hours h4')); // const hero = new ElementAnimation(document.querySelector('.hero-section-homepage img'));  TODO: take out

  var servicesHeading = new ElementAnimation(document.querySelector('.services-heading'));
  var elemObjArr = [].concat(_toConsumableArray(h1ObjArr), _toConsumableArray(reservationsLinksObjArr), _toConsumableArray(hoursDivObjArr), [h3, reservationsH4, hoursH4, servicesHeading]);
...

{
  ...
  var _heading = new ElementAnimation(document.querySelector('.headings-testimonials h2'));
      ...
      var menuCss = function menuCss() {
        ...
        if (typeof document.createElement('div').style.grid !== 'undefined' && window.matchMedia('(min-width: 900px)').matches) {
          for (var _i2 = 0, _j2 = beltArr.length; _i2 < _j2; _i2++) {
            ...
            if (_i2 !== 3) beltArr[_i2].classList.add('belt-slider-absolute'); // set grid width
...
if (typeof document.getElementsByClassName('js-alcohol-headings')[0] !== 'undefined') {
  ...
  _sliderWindow3 = document.getElementsByClassName('window')[0],
    ...
    myBelt2.beltSlider(e);
      ...
      callBelt3 = function callBelt3(e) {
    myBelt3.beltSlider(e);
  },
      callBelt4 = function callBelt4(e) {
    myBelt4.beltSlider(e);
  },
      callBeltArr = [callBelt1, callBelt2, callBelt3, callBelt4]; // does 3 things: 1) mark alcohol option, 2) switch belt, 3) set window height to belt height
...

{
  ...
  var menuBg = new ElementAnimation(document.getElementsByClassName('menu-background')[0]);
...

{
  ...
  var bg = new ElementAnimation(document.querySelector('.cocktail-finder-search-background'));
